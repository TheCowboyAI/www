...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures_____invoke__h8d11b8619d8092eb: (a: number, b: number) => void;
  readonly closure30_externref_shim: (a: number, b: number, c: any, d: any) => void;
