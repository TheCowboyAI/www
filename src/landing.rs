      ...
      <div class="flex flex-col gap-5">
        ...
        <div>
          <a href="https://github.com/TheCowboyAI/cim-start">
            <h3 class="font-bold text-blue-900 text-4xl">
        ...
        <div>
          <TextButton 
            ...
            content="Free GPTs on OpenAI".to_string() 
          />
        </div>
        <hr class="mt-10 border-black border-2" />
        <div>
          <h3 class="font-bold font-black text-2xl">
            {"Member of:"}
          </h3>
        </div>
        <div>
        ...
        <div class="logo-container">
          <a class="font-bold" href="https://mvp.microsoft.com/en-US/">
            <img
