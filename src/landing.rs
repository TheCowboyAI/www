  ...
  view! {
      ...
      <div class="grid-cols-1 grid md:grid-cols-3 items-justify">
          ...
          <Card
              ...
              text="A live Business Model lets you evolve. Business evolution is the continuous transformation and adaptation of a business to meet changing market demands, technology advancements, and shifts in consumer behavior. Cowboy AI delivers a model that works today and will continue to transform with you going forward."
                  .to_string()
          ...
          <Card
              ...
              text="CIM is a new way to see the world of information. We are transitioning from the world of location-based hierarchical files with rows and columns, to something else..."
                  .to_string()
          ...
          <Card
              ...
              text="This is a machine to control your information and how it is processed. When we say machine... think of the entire internet as a single machine. This is a new enabling technology that will guide you to create a personal information system capable of semantic engagement with all your information, no matter where you choose to create it or store it."
                  .to_string()
          ...
          <Card
              ...
              imgsrc="https://img-prod-cms-rt-microsoft-com.akamaized.net/cms/api/am/imageFileData/RE1Mu3b?ver=5c31"
                  .to_string()
              imgalt="Startup Hub".to_string()
              title="Founders Hub Member".to_string()
              text="Microsoft for Startups Founders Hub helps startups radically accelerate innovation by providing access to industry-leading AI services, expert guidance, and the essential technology needed to build a future-proofed startup."
                  .to_string()
          ...
          <Card
              ...
              text="Microsoft recognizes exceptional community leaders for their technical expertise, positive influence on those around them and commitment to solving real world challenges with cutting-edge technology."
                  .to_string()
