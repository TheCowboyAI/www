            ...
            <nav class="flex flex-col items-center pt-3 pl-3">
                <a href="/">
                    <div class="py-4 flex flex-row svg-container items-center w-20 md:w-32">
                        ...
                        <div class="text-xs md:text-base font-bold caption text-center">
                            Cowboy AI
                        </div>
                    </div>
                </a>
                    ...
                    >
                        ...
                        >
                            ...
                            <g>
                                <path
                                    fill="#000000"
                                    d="M890.431,974.791c69.867,0,126.714-56.838,126.714-126.704c0-69.867-56.847-126.705-126.714-126.705
                                ...
                                <path
                                    fill="#000000"
                                    d="M1393.528,849.313c107.104-90.789,190.083-183.293,228.049-264.898c-9.547,1.934-19.43,2.959-29.544,2.959
                                ...
                                <path
                                    fill="#000000"
                                    d="M323.685,429.749c0-70.146-57.069-127.211-127.215-127.211c-70.142,0-127.207,57.064-127.207,127.211
                                ...
                                <path
                                    fill="#000000"
                                    d="M1603.526,302.538c-70.146,0-127.211,57.064-127.211,127.211c0,70.142,57.064,127.211,127.211,127.211
                                ...
                                <path
                                    fill="#000000"
                                    d="M892.983,1541.145c-70.142,0-127.206,57.064-127.206,127.211s57.064,127.211,127.206,127.211
