            ...
            <h1 class="font-bold rounded-lg shadow shadow-black p-2 text-center theme_bg-1-bg-2 theme_bg-1-color-5 text-xl" id="architecture">
                ...
                <ul class="mr-5 
                  ...
                  text-sm md:text-base mt-5 px-5 py-2 theme_bg-1-color-5">
                    ...
                    <li class="ml-2 text-black">{"Guided generation of your Business Model Canvas"}</li>                    
                    <li class="ml-2 mt-2 text-black">{"Knowledge Graphs for Business"}</li>
                    <li class="ml-2 mt-2 text-black">{"Learn, Create and Use Event Sourced systems"}</li>
                    ...
                    <li class="ml-2 text-black">{"Build determinate systems, Deploy them anywhere"}</li>
